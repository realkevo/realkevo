...
I build practical technology solutions that help businesses streamline operations, automate repetitive tasks, and deliver seamless user experiences. My work spans **Android applications, web apps, backend systems, and offline-first solutions**.  

- I develop **business-ready Android & Flutter applications**  
- I create **interactive web apps** using **Svelte** and modern frameworks  
- I implement **automation pipelines** to handle repetitive tasks efficiently  
- I integrate **APIs, authentication flows, and background services** for smooth workflows  
- I focus on **performance, maintainability, and reliability**  
...
- **Eye - Offline Image Scanner** – AI-powered offline app for image similarity detection. [View Project](https://github.com/realkevo/EyeReadme/tree/main?tab=readme-ov-file)  
- **Smart Scanner App** – On-device image similarity detection with optimized processing  
